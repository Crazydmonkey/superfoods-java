...
<head>
    ...
    .food-info .pic1 ,.food-info .pic2,.food-info .pic3,.food-info .pic4,.food-info .pic5{
        width: 60px;
        height: 60px;
        float: left;
        margin-top: 5px;
...
<body>
    ...
    <span><input type="button" value="购物车图片"></span>
	</header>
	      ...
	      <li>
	      	<div class="food-info">
                        ...
                        <div class="details">
                            <p>商品名称</p>
                            <span>详情</span><br>
                            <span class="price"><i class="iconfont icon-price"></i>22</span>
                        </div>
